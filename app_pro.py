...
def load_model_and_labels():
    with open("student_multi_model.pkl", "rb") as f:
        model = pickle.load(f)
...
with tab5:
    ...
    # ---------- Section 1: Overall Dataset Stats ----------
    ...
    # ---------- Section 3: Score Gaps ----------
    st.subheader("📈 Score Gaps")
    ...
    # ---------- Section 4: Study & Attendance Quality Bands ----------
    st.subheader("📊 Performance Distribution by Attendance & Study Hours")
...
with tab6:
    ...
    # Categorical inputs from JSON mappings
